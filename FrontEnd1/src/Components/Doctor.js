                        ...
                        <div className="col-sm-4">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/updatetimetable")} className="btn btn-primary">UPDATE</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-sm-4">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/doctorcurrentappointments")} className="btn btn-primary">CHECK</button>
                                </div>
                            </div>
                        </div>
