...
function PatientRegistration(){
    ...
    const validateAddress=(e)=>{
        ...
        if(address === ""){
            setError({...Error,address_error:"Please enter Address"});
    ...
    const submitData=(e)=>{
        ...
        if(flag.userName&&flag.password&&flag.firstName&&flag.lastName&&flag.mobileNumber&&flag.dob&&flag.bloodGroup&&flag.address)
            {
                const reqOptions ={
                    method : 'POST',
                    headers: {
    ...
    <div className = "row my-4">
        ...
        <form method="POST">
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="password" autoComplete="on" placeholder="Password" name="password" className="form-control" 
