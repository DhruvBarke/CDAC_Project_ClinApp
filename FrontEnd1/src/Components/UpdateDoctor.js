...
const validateAddress=(e)=>{
    ...
    if(address === ""){
      ...
      const submitData=(e)=>{
        ...
        if(flag.firstName&&flag.lastName&&flag.mobileNumber&&flag.speciality&&flag.fees&&flag.address){
                const reqOptions ={
                    method : 'POST',
                    headers: {
         ...
         <form method="POST">
          ...
          <div style={{ marginTop: '10px' }} className = "form-group">
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                ...
                <input type="text" placeholder={data.address} name="fees" className="form-control" 
