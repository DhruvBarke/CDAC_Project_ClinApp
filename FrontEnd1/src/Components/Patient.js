                    ...
                    <div className="col-sm-4">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/AllDoctorList")} className="btn btn-primary">BOOK</button>
                                </div>
                            </div>
                    </div>
                    <div className="col-sm-4">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <button onClick={() => navigate("/patientcurrentappointments")} className="btn btn-primary">CHECK</button>
                            </div>
                        </div>
                    </div>
                    {/* <div className="col-sm-6">
