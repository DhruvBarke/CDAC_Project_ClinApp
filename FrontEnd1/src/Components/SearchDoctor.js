...
function SearchDoctor(){
    ...
    const search=(ev)=>{
        ...
        if(specId === "" ){
            ...
            setError("");
            fetch("http://localhost:8080/alldoctors/"+specId)
            .then(r => r.json())
            .then(d => setDoctor(d)) 
...
<div>
                ...
                <div style={{ marginTop: '10px' }} className="form-group">
                    ...
                    <select style={{ marginLeft: '10px', marginTop: "10px" }} name="areaId" 
                    onChange={fetchSpeciality}
                    // onChange={setSpec}
                    >
                ...
                <button className='btn btn-primary' style={{ marginLeft: "10px", marginTop: "10px" }} onChange={search} >Search</button>
